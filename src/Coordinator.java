...
public class Coordinator {
    ...
    private static String prodHostIP = "";
    private static String consHostIP = "";
    public static void initialize() throws UnknownHostException {
        InetAddress inetAddress = InetAddress.getLocalHost();
        prodHostIP = inetAddress.getHostAddress();
    ...
    public static void putRequest(int i) throws IOException {
        URL url = new URL ("http://"+prodHostIP+":"+StringConstants.producerPort+"/newEntry");
    ...
    public static void getRequest(String movie, String rating) throws IOException, InterruptedException {
        ...
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create("http://"+consHostIP+":"+StringConstants.consumerPort+"/updateEntry/"+movie+"/"+rating))
                .build();
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        prodHostIP = args[0];
        consHostIP = args[1];
        System.out.println("Producer host IP address: " + prodHostIP + " Consumer host IP address: " + consHostIP);
        initialize();
        for(int i = 1; i<=5; i++){
            putRequest(i);
